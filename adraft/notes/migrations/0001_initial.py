    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(max_length=150, upload_to=adraft.notes.models.get_upload_to, validators=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=100, verbose_name='Title')),
                ('description', models.CharField(max_length=255, verbose_name='Description')),
                ('image', models.ImageField(upload_to=adraft.notes.models.get_upload_to, validators=[
                    adraft.notes.models.FileValidator(content_types=('image/gif', 'image/jpeg', 'image/pjpeg', 'image/png', 'image/svg+xml', 'image/tiff', 'image/vnd.microsoft.icon', 'image/vnd.wap.bmp'), max_size=5242880, min_size=10)])),
