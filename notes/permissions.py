...
class NoteAuthorCanEditPermission(SafeMethodsOnlyPermission):
    ...
    def has_object_permission(self, request, view, obj=None):
        ...
        return can_edit or super(NoteAuthorCanEditPermission, self).has_object_permission(request, view, obj)
